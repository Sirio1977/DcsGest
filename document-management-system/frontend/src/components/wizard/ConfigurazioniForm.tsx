...
import { Form, Input, Button, Row, Col, Select, InputNumber, Switch, Typography, Divider } from 'antd';
...
const ConfigurazioniForm: React.FC<Props> = ({ onNext, onPrev, initialData }) => {
  ...
  const modalitaPagamentoPredefinte = [
    'Contanti',
    'Bonifico bancario',
    'Assegno',
    ...
    <div>
      ...
      <Form
        ...
        initialValues={{
          ...
          aliquoteIva: aliquoteIvaPredefinte,
          modalitaPagamento: modalitaPagamentoPredefinte,
        }}
        style={{ maxWidth: '800px' }}
      >
        {/* Numerazioni Documenti */}
        <Title level={4}>Numerazioni Documenti</Title>
        <Paragraph type="secondary">
        ...
        {/* Aliquote IVA */}
        <Title level={4}>Aliquote IVA</Title>
        <Paragraph type="secondary">
        ...
        <Title level={4}>Modalità di Pagamento</Title>
        <Paragraph type="secondary">
        ...
        <Title level={4}>Impostazioni Avanzate</Title>
